...
class VisualizationDemo(object):
    ...
    def visualize_prediction(
        ...
        #mesh.textures = self.colors[label]
        path_manager = PathManager()
        with _open_file(save_file,path_manager, "wb") as f:
            _save_ply(f=f, verts=verts, faces=faces,verts_normals = None, verts_colors = sphere_verts_rgb,ascii=False,colors_as_uint8=True)
